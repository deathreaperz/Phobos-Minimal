...
static COMPILETIMEEVAL std::array<const char* const, (size_t)MouseCursorType::count> MouseCursorTypeToStrings {
	{
		...
		{ "NoMoveNE" }, { "NoMoveE" }, { "NoMoveSE" }, { "NoMoveS" }, { "NoMoveSW" },
		{ "NoMoveW" }, { "NoMoveNW" }, { "Select" }, { "Move" }, { "NoMove" },
		{ "Attack" }, { "AttackOutOfRange" }, { "CUR_16" }, { "DesolatorDeploy" }, { "CUR_18" },
		{ "Enter" }, { "NoEnter" }, { "Deploy" }, { "NoDeploy" }, { "CUR_1D" },
