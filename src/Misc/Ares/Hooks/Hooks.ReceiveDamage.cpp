...
DEFINE_FUNCTION_JUMP(LJMP, 0x517FA0, FakeInfantryClass::_Take_Damage);
...
#pragma region Unit
DEFINE_FUNCTION_JUMP(LJMP, 0x737C90, FakeUnitClass::_Take_Damage);
DEFINE_FUNCTION_JUMP(VTABLE, 0x7F5DDC, FakeUnitClass::_Take_Damage);
