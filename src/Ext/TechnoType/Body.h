...
public:
	...
	TechnoTypeExtData(TechnoTypeClass* pObj) : ObjectTypeExtData(pObj),
		...
		Weeder_PipIndex(),
		Weeder_PipEmptyIndex(),
		CanBeDriven(true),
		CloakPowered(false),
		CloakDeployed(false),
		ProtectedDriver(false),
		ProtectedDriver_MinHealth(),
		KeepAlive(),
		...
		Tiberium_PipIdx(),
		Tiberium_EmptyPipIdx(),
		Tiberium_PipShapes(nullptr),
		Tiberium_PipShapes_Palette(),
		Tint_Color(),
		Tint_Intensity(0.0),
		...
		RefinerySmokeParticleSystemOne(),
		RefinerySmokeParticleSystemTwo(),
		RefinerySmokeParticleSystemThree(),
		RefinerySmokeParticleSystemFour(),
		SubterraneanSpeed(-1),
		ForceWeapon_InRange(),
