...
ASMJIT_PATCH(0x6A4F0B, SidebarClass_CTOR, 0x5)
{
...
ASMJIT_PATCH(0x6AC82F, SidebarClass_DTOR, 0x5)
{
...
ASMJIT_PATCH(0x6AC5E0, SidebarClass_SaveLoad_Prefix, 0x5)
{
	...
	return 0;
}ASMJIT_PATCH_AGAIN(0x6AC5D0, SidebarClass_SaveLoad_Prefix, 0x5)

ASMJIT_PATCH(0x6AC5DA, SidebarClass_Load_Suffix, 0x6)
{
...
ASMJIT_PATCH(0x6AC5EA, SidebarClass_Save_Suffix, 0x6)
{
	auto buffer = SidebarExtData::Instance();
